...
uw_CurlFfi_curl uw_CurlFfi_mkCurl(uw_context ctx, uw_Basis_string verb);
uw_CurlFfi_curl uw_CurlFfi_setBodyString(uw_context ctx, uw_CurlFfi_curl curlstruct, uw_Basis_string body);
uw_CurlFfi_curl uw_CurlFfi_setBodyBlob(uw_context ctx, uw_CurlFfi_curl curlstruct, uw_Basis_blob body);
